#!/bin/urs/python
# kalo mau pake ya setidaknya follow akun github gw
# wa author: 085641586682
# yang Record tapi ga subscribe channel YouTube kZtotorial
# Semoga Masuk Neraka amin
...
mengetik ("\033[32;1m'FOLLOW AKUN GITHUB GW BRO:V\033[32;1m'")
mengetik ("\033[32;1m'MASA PAKAI DOANG TAPI NGGAK FOLLOW:V\033[32;1m'")
time.sleep(4)
os.system("clear")
...
{m}┳━┳┳━┳┳━┳┳━┳┳━┳┳━┳┳━┳┳━┳┳━┳┳━┳┳━┳┳━┳┳━┳┳━┳┳━┳
{sp}
{m}<════════════[{k} •  {p} SCRIPT UNTUK SPAM SMS{k} •{m} ]══════════════>
{k}STATUS SCRIPT>{hi} RUNNING
{c}𝙲𝚈𝙱𝙴𝚁 𝚂𝙴𝙲𝚄𝚁𝙸𝚃𝚈
{p}<════════════════════════════════════════════════════>
{k} AUTHOR{p}:{hi} CyberCarboon x Julio.Pangkey
{k}GitHub{p}:{hi} https://github.com/CyberCarboon
{k}Facebok{p}:{hi} Smart Danie
{p}<════════════════════════════════════════════════════>
{m} ════════════[{p}MASUKKAN NOMOR TARGET]{m}════════════
""")
